@php
 $nav_links =[
        ...
        [
            ...
            'active' => request()->routeIs('courses.*')//Con asterisco cualquier ruta que empieza con course hara que este activo
        ],
    ...
    <div class="container">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <!-- Settings Dropdown -->
                <div class="ml-3 relative">
                    {{--  Esta directiva solo lo mostrara si el usuario esta autentificado  --}}
                    @auth
                    ...
                    {{--  Sino esta autentificado nos mostrar estos link  --}}
                    @else
