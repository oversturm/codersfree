        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="update">
                <div class="flex items-center">
                    ...
                    <input wire:model="lesson.name" type="text"
                        class="mt-1 focus:ring-gray-400 focus:border-gray-400 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                ...
                <div>
                    <div class="flex items-center mt-4">
                        ...
                        <input wire:model="lesson.url" type="text"
                            class="mt-1 focus:ring-gray-400 focus:border-gray-400 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                </div>
                @error('lesson.url')
                ...
                <div class="mt-4 flex justify-end">
                    ...
                    <button type="submit" class="btn btn-primary ml-2 text-xs">Actualizar</button>
                </div>
            ...
            <div x-show="open">
                ...
                <p class="text-sm">Enlace: <a class="text-blue-400" href="{{ $item->url }}"
                ...
                <div>
                    @livewire('instructor.lesson-resources', ['lesson' => $item], key('instructor.lesson-resources' . $item->id))
                </div>
            </div>
            @endif
        </div>
