<form class="pt-2 relative mx-auto text-gray-600" autocomplete="off ">
    ...
    <button type="submit" class="py-2 px-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 absolute right-0 top-0 mt-2 ">
        Buscar
    </button>
    @if ($search)
